...
// const SubAdminUsers = ({ navigation }) => {
...
import { MaterialIcons } from '@expo/vector-icons';  // ✅ Use Expo's built-in icons
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#f5f5f5', paddingTop: 60, paddingHorizontal: 10 },
  heading: { fontSize: 22, fontWeight: 'bold', marginBottom: 20, textAlign: 'center', color: '#333' },
  topRightButton: { position: 'absolute', top: 20, right: 20, backgroundColor: '#2F4EAA', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 5, zIndex: 999, elevation: 3 },
  buttonText: { color: '#fff', fontSize: 14, fontWeight: 'bold' },
  listContainer: { paddingBottom: 20 },
  card: { backgroundColor: '#fff', borderRadius: 10, padding: 15, margin: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3, flex: 1, width: Dimensions.get('window').width > 600 ? '48%' : '100%' },
  ...
  infoLabel: { fontSize: 16, fontWeight: 'bold', width: 80, color: '#555' },
  infoValue: { flex: 1, color: '#333' },
  actionsContainer: { flexDirection: 'row', alignItems: 'center' },
  actionButton: { marginHorizontal: 5 },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginLeft: 5, backgroundColor: '#e0e0e0',
 },
 statusActiveBadge: { 
