...
// export class SubAdminDashboard extends Component {
//   render() {
//     return (
//       <View>
//         <Text> SubAdminDashboard </Text>
//       </View>
//     )
//   }
// }
...
export class SubAdminDashboard extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        {/* Rating Card Section */}
                <Text style={styles.sectionTitle}>SubAdminDashboard </Text>
    ...
    <View key={`rating-${stars}`}>
      {this.renderRatingBar(
        ...
        <View style={styles.statsRow}>
          ...
          {this.renderStatsCard(
            <MaterialCommunityIcons name="currency-usd" size={24} color="#2F4EAA" />,
            `$${stats.totalAmount}`,
            'Total Revenue',
            '#2F4EAA'
          )}
