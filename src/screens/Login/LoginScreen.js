...
const VendorLoginScreen = ({ navigation }) => {
  ...
  //   redirectUri: 'https://auth.expo.io/@iiiqbets/yasla-vendor', 
  // });
  const [request, response, promptAsync] = Google.useAuthRequest({
  // Use only the webClientId for APK builds
  webClientId: '796283920864-ugon3v43r514s98aab1cf91qt4vhtb0c.apps.googleusercontent.com',
  scopes: ['openid', 'profile', 'email'],
  redirectUri: 'https://auth.expo.io/@iiiqbets/yasla-vendor',
});
